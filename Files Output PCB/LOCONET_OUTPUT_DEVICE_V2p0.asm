...
;*                                                                         *
;* Datum: 16 apr 2023             Versie LOCONET OUTPUT DEVICE V2.0        *
;*                                                                         *
;* Filenaam: LOCONET_OUTPUT_DEVICE_V2p0.asm                                          *
;*     	                                                                   *
...
;*                 DIP9   | 1  RE3 *  *  RB7 40 |      poort 16            *
;*      Comperator Vin-   | 2  RA0  **   RB6 39 |      poort 15            *
...
;***************************************************************************
    ...
    #include LOCONET_IO_VARIABELEN_OUTPUT_V2p0.inc
...
;******************************************************************************
    ...
    ORG 00018h
	GOTO Low_Priority_Interrupt		;LOCONET_18F4X20.INC

	
;********************************************************************************


    #include LOCONET_18F4X20.INC

    #include LOCONET_IO_PROCEDURES_OUTPUT_V2p0.inc

    #include LOCONET_DECODEER_OUTPUT_V2p0.inc
...
MAIN
        ...
        CALL INIT_LOCONET                   ;LOCONET_18F4X20.INC   
...
VOLGENDE
        CALL TEST_NIEUWE_TE_VERZENDEN_DATA  
        CALL DECODEER_LOCONET_DATA  
	
	BTFSS SV ;S/I
	CALL UPDATE_S88_OUTPUT
